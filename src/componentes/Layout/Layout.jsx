...
import { PedidosDash } from "../PedidosDash/PedidosDash"
...
export const Layout = () => {
  ...
  return (
    ...
    <Routes>
        ...
        <Route path='/cambiar-password' element={<ResetPass type={"cambiar-password"}/>}/>
        <Route path='/restablecer-password' element={<ResetPass type={"restablecer-password"}/>}/>
        ...
        <Route path='/dashboard/*' element={<Dashboard/>}>
          ...
          <Route path='pedidos' element={<PedidosDash/>}/>
          ...
          <Route path='editar-producto/:productoId' element={<ProductEditDash/>}/>
